...
async function main() {
  ...
  const feedbackComments = [
    ...
    [
      { comment: "季節感のある素材をもっと追加してください。桜や新緑など。", ts: 10 },
      { comment: "テキストの表示時間が短いです。読みきれません。", ts: 25 },
    ],
    [
      { comment: "会社の雰囲気が伝わりにくいです。オフィス内の映像を追加してください。", ts: null },
    ],
    [
      { comment: "サービスの特徴が3つありますが、2つ目の説明が不足しています。", ts: 20 },
      { comment: "最後のCTAがわかりにくいです。「無料体験はこちら」を大きく表示してください。", ts: 55 },
    ],
    [
      { comment: "コラボ相手のロゴが小さすぎます。もう少し目立つようにしてください。", ts: 3 },
      { comment: "中盤のトークパートが間延びしています。カットして短くしてください。", ts: 35 },
      { comment: "エンドカードのSNSアカウント情報が古いです。最新に更新してください。", ts: 58 },
    ],
    [
      { comment: "セール期間の日付表示をもっと大きく目立たせてください。", ts: 8 },
      { comment: "BGMが明るすぎます。もう少し落ち着いたトーンでお願いします。", ts: null },
    ],
  ];
